...
<div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-8">
                        <form role="form" action="{{ route('client-do-add') }}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade in <?php echo $lang == 'ar' ? 'active' : ''; ?>" id="nav-{{ $lang }}">
                                    ...
                                    <div class="form-group">
                                        <label> الوصف </label>
                                        <textarea rows="10" class="form-control" type="text" name="text[{{ $lang }}]" ></textarea>
                                    </div>
