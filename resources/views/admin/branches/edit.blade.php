...
<div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-8">
                        <form role="form" action="{{ route('branch-do-edit') }}" enctype="multipart/form-data" method="post">
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                @foreach ($data as $item)
                                    ...
                                    <div class="tab-pane fade in <?php echo $item->lang == 'ar' ? 'active' : ''; ?>" id="nav-{{ $item->lang }}">
                                        ...
                                        <div class="form-group">
                                            <label> العنوان </label>
                                            <input class="form-control" type="text" value="{{ $item->address }}" name="address[{{ $item->lang }}]" >
                                        </div>

                                        <div class="form-group">
                                            <label> المدير </label>
                                            <input class="form-control" type="text" value="{{ $item->manger }}" name="manger[{{ $item->lang }}]" >
                                        </div>
