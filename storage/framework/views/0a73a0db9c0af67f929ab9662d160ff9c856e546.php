...
<div class="page-header"
    ...
    <div class="max-overlay">
        <div class="container">
            <div class="col-sm-6">
                <h1 class="title"><?php echo app('translator')->get('site.team'); ?></h1>
            </div>
            <div class="col-sm-6">
                <h3>
                    <div class="breadcrumbs"><span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a
                            ...
                            class="current"><?php echo app('translator')->get('site.team'); ?></span></div><!-- .breadcrumbs -->
                </h3>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3 flex">
            <div class="b-single cli">
                ...
                <div class="exc">
                    ...
                    <h5 class="job"></h5>
                    <a
                        href="<?php echo e(route('team-one',$item->name )); ?>">
...
<?php echo $__env->make('web.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alsudais/public_html/resources/views/web/team.blade.php ENDPATH**/ ?>